...
$movies = readMovies('data/action.txt');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
foreach ($movies as $mov) {
  ...
  echo '<td class="mdl-data-table__cell--non-numeric"><span style="font-size: 30px;"><a href="action.php?movie=' . $mov['name'] . '">' . $mov['name'] . '</a></td>';
...
<div class="mdl-card__supporting-text">
<?php
    $reviews = readReviews($_GET['movie'], 'data/action.txt');
    if (is_null($reviews)) {
