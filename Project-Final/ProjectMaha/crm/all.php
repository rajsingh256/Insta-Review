...
$movies = readMovies('data/all.txt');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
foreach ($movies as $mov) {
  ...
  echo '<td class="mdl-data-table__cell--non-numeric"><span style="font-size: 30px;"><a href="all.php?movie=' . $mov['id'] . '">' . $mov['name'] . '</a></td>';
...
<div class="mdl-card__supporting-text">
<?php
    $reviews = readReviews($_GET['movie'], 'data/allrev.txt');
    if (is_null($reviews)) {
